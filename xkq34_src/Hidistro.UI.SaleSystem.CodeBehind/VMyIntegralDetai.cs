namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VMyIntegralDetai : VMemberTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            this.litSurplusIntegral.Text = currentMember.Points.ToString();//剩余积分
            this.litSumIntegral.Text = Convert.ToInt32(MemberProcessor.GetIntegral(currentMember.UserId)).ToString();//获取总积分
