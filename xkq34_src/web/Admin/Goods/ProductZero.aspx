    ...
    <div id="mytabl">
        ...
        <div class="table-page">
            <ul class="nav nav-tabs">
                <li><a href="ProductOnSales.aspx"><asp:Literal ID="LitOnSale" runat="server"></asp:Literal></a></li>
                <li><a href="ProductOnStock.aspx"><asp:Literal ID="LitOnStock" runat="server"></asp:Literal></a></li>
                <li class="active"><a href="#messages"><asp:Literal ID="LitZero" runat="server"></asp:Literal></a></li>
                <li><a href="ProductSendsIntegral.aspx"><asp:Literal ID="LitSendsIntegral" runat="server"></asp:Literal></a></li>
                <li><a href="ProductPointsFor.aspx"><asp:Literal ID="LitPointsFor" runat="server"></asp:Literal></a></li>
                <li><a href="ProductZeroBy.aspx"><asp:Literal ID="LitZeroBy" runat="server"></asp:Literal></a></li>
            </ul>
            <div class="page-box">
                <div class="page fr">
                ...
                <div class="set-switch">
                    <div class="form-inline mb10">
                        ...
                        <div class="form-group mr20 isetwidth">
                            <label for="sellshop2">
                                商品分类：</label>
                            <Hi:ProductCategoriesDropDownList ID="dropCategories" CssClass="form-control resetSize"
                                runat="server" NullToDisplay="请选择商品分类" />
                        </div>
                                    ...
                                    <td colspan="8">
                                        <div class="mb10 table-operation">
                                            ...
                                            <asp:Button ID="btnDelete" runat="server" Text="删除" CssClass="btn resetSize btn-danger"
                                                OnClientClick="return HiConform('<strong>确定要执行删除操作吗？</strong><p>删除后商品将进入回收站，分销商的相关商品也将被删除！</p>', this);" />
                                            &nbsp;︱
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td width="30%">
                                                ...
                                                <div class="shop-info">
                                                    <p class="mb5" title="<%#Server.HtmlEncode(Eval("ProductName").ToString()) %>">
                                                        <%#Hidistro.Core.Globals.SubStr(Eval("ProductName").ToString(),68,"...") %></p>
                                                    ...
                                                    <a title="点击复制商品链接" class="fz" href="javascript:void(0)" data-clipboard-target='urldata<%# Eval("ProductId") %>'
                                            ...
                                            <td width="7%">
                                                <p>
                                                    <a href="<%#"ProductEdit.aspx?productId="+Eval("ProductId")%>&reurl=<%=LocalUrl %>">
                                                        编辑</a> &nbsp;| &nbsp; <a href="<%#"ProductEdit.aspx?productId="+Eval("ProductId")%>&isnext=1&reurl=<%=LocalUrl %>">
                                                            详情</a>
                                                </p>
                                                <p>
                                                    <asp:Button ID="btnDel" CommandName="Delete" CommandArgument='<%# Eval("ProductId") %>'
                                                        runat="server" CssClass="btnLink pad" Text="删除" OnClientClick="return HiConform('<strong>确定要执行删除操作吗？</strong><p>删除后商品将进入回收站，分销商的相关商品也将被删除！</p>',this);" />
                                                </p>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                    关闭</button>
                                <asp:Button ID="btnUpSale" runat="server" OnClientClick="return StockZore();" Text="上架商品"
