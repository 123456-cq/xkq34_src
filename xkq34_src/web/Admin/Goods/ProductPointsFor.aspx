<%@ Page Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true"
    CodeBehind="ProductPointsFor.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ProductPointsFor" %>
                ...
                $.get("/API/AdminNoSelPointsFor.ashx", { Method: "NoSelPointsFor", PageIndex: PageIndex }, function (data) {
                    ...
                    for (var j = 0; j < data.dt.length; j++) {
                        ...
                        $(".modal-body").append("<li><div><input name='CheckBoxGroup' class='fl' type='checkbox' value='24'></div><div style='float:left' ID =" + data.dt[j].ProductId + "><img src=" + data.dt[j].ThumbnailUrl60 + "></div>" +
                         ...
                         "<span style='display:block; margin-left:20%;'> 原价：" + data.dt[j].SalePrice + "</span></p></div><div class='goods-jia' style='display:none'><input type='text' placeholder='积分兑换上限' title='请填写可兑换积分值' class='song' maxlength='4' ><button type='button' class='btn btn-primary' name='AddButton'>添加</button></div></li>")
                    ...
                    $("[name=AddButton]").bind("click", function () {
                        ...
                        $.get("/API/AdminNoSelPointsFor.ashx", { Method: "AddPointsFor", IntegralCeiling: Integral, ProductId: ProductId }, function (data) {
                                    ...
                                    <td colspan="8">
                                        <div class="mb10 table-operation">
                                            ...
                                            <asp:Button ID="btnDelete" runat="server" Text="删除" CssClass="btn resetSize btn-danger"
                                                OnClientClick="return HiConform('<strong>确定要执行删除操作吗？</strong><p>积分兑换列表则删除此商品！</p>', this);" />
                                            &nbsp;︱
                                            ...
                                            <td width="7%">
                                                <p>
                                                    <a href="<%#"ProductEdit.aspx?productId="+Eval("ProductId")%>&reurl=<%=LocalUrl %>">
                                                        编辑</a> &nbsp;| &nbsp;<asp:Button ID="Button1" CommandName="Delete" CommandArgument='<%# Eval("ProductId") %>'
                                                            runat="server" CssClass="btnLink pad" Text="删除" OnClientClick="return HiConform('<strong>确定要执行删除操作吗？</strong><p>积分兑换列表则删除此商品！</p>',this);" />
                                                </p>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
