    ...
    <div id="mytabl">
        ...
        <div class="table-page">
            <ul class="nav nav-tabs">
                ...
                <li><a href="ProductSendsIntegral.aspx">
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="mb10 table-operation">
                                            ...
                                            <label for="sells1">
                                                全选</label>
                                            <button type="button" class="btn resetSize btn-primary" onclick="SelectOperation('1');">
                                                上架</button>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td width="7%">
                                                ...
                                                <p>
                                                    <asp:Button ID="btnUnSaleProduct" CommandName="UnSaleProduct" CommandArgument='<%# Eval("ProductId") %>'
                                                        runat="server" CssClass="btnLink pad" Text="上架" OnClientClick="return HiConform('<strong>确定要上架所选商品吗？</strong><p>上架后商品将在前台显示！</p>',this);" />&nbsp;︱
