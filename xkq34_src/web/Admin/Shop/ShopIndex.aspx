<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopIndex.aspx.cs" MasterPageFile="~/Admin/AdminNew.Master"
    Inherits="Hidistro.UI.Web.Admin.Shop.ShopIndex" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="set-switch clearfix">
        ...
        <div class="usertemplateInfo">
            ...
            <p class="mb20">
                手机扫描此二维码，可直接在手机上访问店铺</p>
            <p class="mb20">
                店铺网址：<br>
                <%=showUrl %></p>
            <p class="mb20">
                模板名称：<%=templateCuName %></p>
            <input type="button" class="btn btn-primary mt20" value="编辑模板" dataid="<%= GetTempUrl(tempLatePath)%>"
                id="btn_edit" />
            <div class="linkCopy">
                <input type="button" class="btn btn-primary inputw100 mb10" style="display: block;"
                    id="btn_show" value="预览" />
