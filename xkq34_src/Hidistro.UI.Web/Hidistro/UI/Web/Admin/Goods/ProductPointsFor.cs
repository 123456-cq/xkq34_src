namespace Hidistro.UI.Web.Admin.Goods
{
    ...
    public class ProductPointsFor : AdminPage
    {
        ...
        protected Literal LitSendsIntegral;//购物送积分
        protected Literal LitPointsFor;//积分兑换
        protected Literal LitZeroBy;//零元购
        ...
        private void BindProducts()
        {
            ...
            DbQueryResult products = ProductHelper.GetPointsForProducts(entity);//获取积分兑换商品数据
            ...
            DataTable dt = service.SelSendIntegralCount();//查询购物送积分，积分兑换商品数量

            this.LitSendsIntegral.Text = "购物送积分(" + dt.Rows[0]["integral"].ToString() + ")";
            this.LitPointsFor.Text = "积分兑换(" + dt.Rows[0]["IntegralToNow"].ToString() + ")";
            this.LitZeroBy.Text = "零元购(" + dt.Rows[0]["ZeroBuy"].ToString() + ")";
        ...
        private void btnDelete_Click(object sender, EventArgs e)//批量删除商品
        {
            ...
            else if (ProductHelper.DelPointsForProducts(str) > 0)
            {
        ...
        private void grdProducts_ItemCommand(object sender, RepeaterCommandEventArgs e)//删除单个商品
        {
            if (e.CommandName == "Delete")
            {
                if (ProductHelper.DelPointsForProduct(e.CommandArgument.ToString()) > 0)
                {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.grdProducts.ItemCommand += new RepeaterCommandEventHandler(this.grdProducts_ItemCommand);//删除单个商品
