namespace Hidistro.UI.Web.Admin.Goods
{
    ...
    public class ProductZeroBy : AdminPage
    {
        ...
        private void BindProducts()
        {
            ...
            DbQueryResult products = ProductHelper.GetZeroByProducts(entity);//获取零元购商品数据
            ...
            DataTable dt = service.SelSendIntegralCount();//查询购物送积分，积分兑换，零元购商品数量
        ...
        private void btnDelete_Click(object sender, EventArgs e)//批量删除商品
        {
            ...
            else if (ProductHelper.DelZeroByProducts(str) > 0)
            {
        ...
        private void grdProducts_ItemCommand(object sender, RepeaterCommandEventArgs e)//删除单个商品
        {
            ...
            {
                if (ProductHelper.DelZeroByProduct(e.CommandArgument.ToString()) > 0)
                {
