namespace Hidistro.SqlDal.Commodities
{
    ...
    public class ProductDao
    {
        ...
        /// <returns></returns>
        public DbQueryResult GetSendsIntegralProducts(ProductQuery query)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append(" 1=1 ");
            ...
            return DataHelper.PagingByRownumber(query.PageIndex, query.PageSize, query.SortBy, query.SortOrder, query.IsCount, "vw_Hishop_SendsIntegralProductList p", "ProductId", builder.ToString(), selectFields);//vw_Hishop_BrowseProductList p  视图名称
        } 
        #endregion
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public DbQueryResult GetPointsForProducts(ProductQuery query)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append(" 1=1 ");
            if (string.IsNullOrEmpty(query.TwoSaleStatus))
            ...
            string selectFields = "SaleCounts,ThumbnailUrl60,ThumbnailUrl310,ProductId, ProductCode,IsMakeTaobao,ProductName,ProductShortName, ThumbnailUrl40, MarketPrice, ShortDescription,MaxShowPrice,SalePrice, (SELECT CostPrice FROM Hishop_SKUs WHERE SkuId = p.SkuId) AS  CostPrice,  Stock, DisplaySequence,SaleStatus,AddedDate";
            return DataHelper.PagingByRownumber(query.PageIndex, query.PageSize, query.SortBy, query.SortOrder, query.IsCount, "vw_Hishop_PointsForProductList p", "ProductId", builder.ToString(), selectFields);//vw_Hishop_BrowseProductList p  视图名称
        }
        #endregion
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public DbQueryResult GetZeroByProducts(ProductQuery query)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append(" 1=1 ");
            if (string.IsNullOrEmpty(query.TwoSaleStatus))
            ...
            string selectFields = "SaleCounts,ThumbnailUrl60,ThumbnailUrl310,ProductId, ProductCode,IsMakeTaobao,ProductName,ProductShortName, ThumbnailUrl40, MarketPrice, ShortDescription,MaxShowPrice,SalePrice, (SELECT CostPrice FROM Hishop_SKUs WHERE SkuId = p.SkuId) AS  CostPrice,  Stock, DisplaySequence,SaleStatus,AddedDate";
            return DataHelper.PagingByRownumber(query.PageIndex, query.PageSize, query.SortBy, query.SortOrder, query.IsCount, "vw_Hishop_ZeroByProductList p", "ProductId", builder.ToString(), selectFields);//vw_Hishop_BrowseProductList p  视图名称
        }
        #endregion
        ...
        public DbQueryResult GetProducts(ProductQuery query)
        {
            ...
            string selectFields = "SaleCounts,ThumbnailUrl60,ThumbnailUrl310,ProductId, ProductCode,IsMakeTaobao,ProductName,ProductShortName, ThumbnailUrl40, MarketPrice, ShortDescription,MaxShowPrice,SalePrice, (SELECT CostPrice FROM Hishop_SKUs WHERE SkuId = p.SkuId) AS  CostPrice,  Stock, DisplaySequence,SaleStatus,AddedDate";
            return DataHelper.PagingByRownumber(query.PageIndex, query.PageSize, query.SortBy, query.SortOrder, query.IsCount, "vw_Hishop_BrowseProductList p", "ProductId", builder.ToString(), selectFields);//vw_Hishop_BrowseProductList p  视图名称
        }
