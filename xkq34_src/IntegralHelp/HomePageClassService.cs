...
namespace IntegralHelp
{
    ...
    public class HomePageClassService
    {
        ...
        public IList<ProductInfo> ShopSendIntegral([Optional, DefaultParameterValue(false)] bool Resort, string ShopNumber)
        {
            ...
            try
            {
                ...
                if (Resort)
                {
                    ...
                    {
                        if (!dictionary.ContainsKey(Convert.ToInt32(row["ProductId"])))
                        {
                            dictionary.Add(Convert.ToInt32(row["ProductId"]), (int)row.Table.Rows.IndexOf(row) + 1);
                        }
        ...
        public IList<ProductInfo> PointsForGoods([Optional, DefaultParameterValue(false)] bool Resort, string ShopNumber)
        {
            IList<ProductInfo> list = new List<ProductInfo>();
            try
            {
                ...
                if (ShopNumber == "four")//展示四个商品
                {
                    sql = "SELECT top (4) * FROM (SELECT P.*,\r\n                (SELECT MIN(SalePrice) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS SalePrice,\r\n                (SELECT TOP 1 SkuId FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS SkuId,\r\n                (SELECT SUM(Stock) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS Stock,\r\n                (SELECT TOP 1 [Weight] FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS [Weight],\r\n                (SELECT COUNT(*) FROM Taobao_Products WHERE ProductId = p.ProductId) AS IsMakeTaobao\r\n                FROM Hishop_Products p)  as A\r\n        left join [dbo].[Hishop_FreightTemplate_SpecifyRegionGroups] on [TemplateId]=[FreightTemplateId]\r\n                 WHERE  A.Stock > 0 AND A.SaleStatus=1  and [IntegralToNow]=1";
                }
                else//展示所有商品
                {
                    sql = "SELECT * FROM (SELECT P.*,\r\n                (SELECT MIN(SalePrice) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS SalePrice,\r\n                (SELECT TOP 1 SkuId FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS SkuId,\r\n                (SELECT SUM(Stock) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS Stock,\r\n                (SELECT TOP 1 [Weight] FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS [Weight],\r\n                (SELECT COUNT(*) FROM Taobao_Products WHERE ProductId = p.ProductId) AS IsMakeTaobao\r\n                FROM Hishop_Products p)  as A\r\n         left join [dbo].[Hishop_FreightTemplate_SpecifyRegionGroups] on [TemplateId]=[FreightTemplateId]\r\n                 WHERE A.Stock > 0 AND A.SaleStatus=1  and [IntegralToNow]=1";
        ...
        public IList<ProductInfo> ZeroBuyGoods([Optional, DefaultParameterValue(false)] bool Resort, string ShopNumber)
        {
            IList<ProductInfo> list = new List<ProductInfo>();
            try
            {
                ...
                if (ShopNumber == "four")//展示四个商品
                {
                    sql = "SELECT top (4) *  FROM (SELECT P.*,\r\n                (SELECT MIN(SalePrice) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS SalePrice,\r\n                (SELECT TOP 1 SkuId FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS SkuId,\r\n                (SELECT SUM(Stock) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS Stock,\r\n                (SELECT TOP 1 [Weight] FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS [Weight],\r\n                (SELECT COUNT(*) FROM Taobao_Products WHERE ProductId = p.ProductId) AS IsMakeTaobao \r\n     FROM Hishop_Products p)  as A\r\n   left join [dbo].[Hishop_FreightTemplate_SpecifyRegionGroups] on [TemplateId]=[FreightTemplateId]\r\n                 WHERE   A.Stock > 0 AND A.SaleStatus=1  and ZeroBuy=1";
                }
                else//展示所有商品
                {
                    sql = "SELECT  *  FROM (SELECT P.*,\r\n                (SELECT MIN(SalePrice) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS SalePrice,\r\n                (SELECT TOP 1 SkuId FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS SkuId,\r\n                (SELECT SUM(Stock) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS Stock,\r\n                (SELECT TOP 1 [Weight] FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS [Weight],\r\n                (SELECT COUNT(*) FROM Taobao_Products WHERE ProductId = p.ProductId) AS IsMakeTaobao \r\n     FROM Hishop_Products p)  as A\r\n   left join [dbo].[Hishop_FreightTemplate_SpecifyRegionGroups] on [TemplateId]=[FreightTemplateId]\r\n                 WHERE A.Stock > 0 AND A.SaleStatus=1  and ZeroBuy=1";
        ...
        public IList<ProductInfo> LeaseGoods([Optional, DefaultParameterValue(false)] bool Resort, string ShopNumber)
        {
            IList<ProductInfo> list = new List<ProductInfo>();
            try
            {
                ...
                if (ShopNumber == "four")//展示四个商品
                {
                    sql = "SELECT top (4) *  FROM (SELECT P.*,\r\n                (SELECT MIN(SalePrice) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS SalePrice,\r\n                (SELECT TOP 1 SkuId FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS SkuId,\r\n                (SELECT SUM(Stock) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS Stock,\r\n                (SELECT TOP 1 [Weight] FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS [Weight],\r\n                (SELECT COUNT(*) FROM Taobao_Products WHERE ProductId = p.ProductId) AS IsMakeTaobao \r\n     FROM Hishop_Products p)  as A\r\n   left join [dbo].[Hishop_FreightTemplate_SpecifyRegionGroups] on [TemplateId]=[FreightTemplateId]\r\n                 WHERE A.Stock > 0 AND A.SaleStatus=1  and LeaseGood=1";
                }
                else//展示所有商品
                {
                    sql = "SELECT  *  FROM (SELECT P.*,\r\n                (SELECT MIN(SalePrice) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS SalePrice,\r\n                (SELECT TOP 1 SkuId FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS SkuId,\r\n                (SELECT SUM(Stock) FROM Hishop_SKUs WHERE ProductId = p.ProductId) AS Stock,\r\n                (SELECT TOP 1 [Weight] FROM Hishop_SKUs WHERE ProductId = p.ProductId ORDER BY SalePrice) AS [Weight],\r\n                (SELECT COUNT(*) FROM Taobao_Products WHERE ProductId = p.ProductId) AS IsMakeTaobao \r\n     FROM Hishop_Products p)  as A\r\n   left join [dbo].[Hishop_FreightTemplate_SpecifyRegionGroups] on [TemplateId]=[FreightTemplateId]\r\n                 WHERE A.Stock > 0 AND A.SaleStatus=1  and LeaseGood=1";
