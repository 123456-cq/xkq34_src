namespace Hidistro.UI.Web.Admin.Goods
{
    ...
    public class ProductSendsIntegral : AdminPage
    { 
        protected Button btnCancelFreeShip;
        protected Button btnDelete;//批量删除商品
        ...
        private void BindProducts()
        {
            ...
            DbQueryResult products = ProductHelper.GetSendsIntegralProducts(entity);//获取购物送积分商品数据
        ...
        private void grdProducts_ItemCommand(object sender, RepeaterCommandEventArgs e)
        {
            ...
            {
                if (ProductHelper.DelSendsIntegralProduct(e.CommandArgument.ToString()) > 0)//删除单个商品
                {
                    this.ShowMsg("删除商品成功！", true);
                    this.ReloadProductOnSales(false);//刷新当前页
                }
                else
                {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.grdProducts.ItemCommand += new RepeaterCommandEventHandler(this.grdProducts_ItemCommand);//删除或下架单个商品
