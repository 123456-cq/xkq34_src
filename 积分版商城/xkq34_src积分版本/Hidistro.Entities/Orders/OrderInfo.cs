namespace Hidistro.Entities.Orders
{
    ...
    public class OrderInfo
    {
        ...
        public bool CheckAction(OrderActions action)
        {
            ...
            if (this.OrderStatus != Hidistro.Entities.Orders.OrderStatus.Finished)
            {
                switch (action)
                {
                    ...
                    case OrderActions.SELLER_CLOSE://已关闭订单

                        return (this.OrderStatus == Hidistro.Entities.Orders.OrderStatus.Closed);

                    case OrderActions.SUBSITE_SELLER_MODIFY_GIFTS://等待卖家付款订单
