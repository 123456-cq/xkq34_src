...
<head>
    ...
    <style type="text/css">
        ...
        .dislogin .vercode .form-control
        {
            width: 195px;
        }
        .dislogin .vercode .imgcode
        {
            position: absolute;
            top: 0px;
            right: 0;
        ...
        .wechatimg, .shoppingimg, .modimg, .userimg
        {
            position: absolute;
            width: 60px;
            height: 60px;
...
<body>
    <div class="dislogin">
        <div class="logoStyle">
            <img src="./images/login-title.png" no-repeat />
        </div>
        ...
        <div class="form-group">
            <label class="control-label" for="passwrod">
                密码</label>
            <div class="dislogin-input">
                <asp:TextBox ID="txtAdminPassWord" CssClass="form-control" runat="server" TextMode="Password"
                    MaxLength="50" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="vercode">
                验证码</label>
            <div class="dislogin-input vercode clearfix">
                ...
                <div class="error">
                    <img id="img_txtCode" src="" alt="" /></div>
...
<%--        <div class="wechat-code">
            <div class="code-img">
                <a href="/utility/pics/wfxqrcode.jpg" target="_blank">
                    <img src="/utility/pics/wfxqrcode.jpg" style="width: 95px; height: 95px;"></a>
            </div>
            <p>
                微信扫描左侧二维码，了解销客多产品最新升级动态。</p>
        </div>--%>
        <div class="wechatimg">
        </div>
