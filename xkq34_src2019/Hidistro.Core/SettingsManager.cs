namespace Hidistro.Core
{
    ...
    public static class SettingsManager
    {
        ...
        {
            HttpContext current = HttpContext.Current;
            string m = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"config\SiteSettings.config"); //((current != null) ? current.Request.MapPath("~/config/SiteSettings.config") :
